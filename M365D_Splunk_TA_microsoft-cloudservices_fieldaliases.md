...
Please note: the TA-App [**Microsoft Azure Add on for Splunk**](https://splunkbase.splunk.com/app/3757/) does not have this field naming issue, but is deprecated for Azure Event Hubs ingestion and therefore shouldn't be used anymore.
