...
Please note: the TA-App [**Microsoft Azure Add on for Splunk**](https://splunkbase.splunk.com/app/3757/) does not have this field naming issue, but is deprecated for Azure Eventhub ingestion and therfore shouldn't be used anymore.
